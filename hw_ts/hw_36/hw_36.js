...
function getGenries(arr) {
    return arr
        .map(function (el) { return el.genre; })
        .join(',')
        .split(',')
...
function getActors(arr) {
    return arr
        .map(function (el) { return el.actors; })
        .join(',')
        .split(',')
        .filter(function (el, index, arr) { return arr.indexOf(el) === index; });
}
...
function getImdbRating(arr) {
    return arr
        .map(function (el) { return el.imdbRating; })
...
function getMovieByTheYear(arr, year) {
    return arr
        .filter(function (el) { return el.year === year; });
}
...
function getMovieByTheString(arr, str) {
    return arr
        .filter(function (el) { return el.title
        .toLowerCase()
...
function f8(arr, keyStr, value) {
    return arr
        .filter(function (el) { return Object.keys(el).includes(keyStr)
